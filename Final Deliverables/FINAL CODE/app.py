...
connState = ibm_db.active(connection)
print(connState)
...
def register():
 if request.method == 'POST':
     try:
      ...
      sql_stmt = "INSERT INTO REGISTRATION VALUES(?,?,?,?);"
      stmt = ibm_db.prepare(connection, sql_stmt)
...
def login():
 ...
 if request.method == "POST":
    username = request.form['username']
    password = request.form['password']
    query = "SELECT * FROM REGISTRATION VALUES where username=? and password=?"
